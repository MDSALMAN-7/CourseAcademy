...
//     try {
//         // const course = await Course.findById(courseId); // to check  course is available or not in databse
//         // if(!course){
//         //     return res.status(404).json({errors:"Course not found"});
//         // }

//         // // to check user have already purchesed this code
//         // const existingPurchase = await Purchase.findOne({userId,courseId});
//         // if(existingPurchase){
//         //     res.status(404).json({error:"This course you have already bought"});
//         //     console.log("This course you have already bought"); 
//         // }

//         // // if this course is not available in database then we create new
//         // const newPurchase = new Purchase({userId,courseId});
//         // await newPurchase.save();  // to save data
